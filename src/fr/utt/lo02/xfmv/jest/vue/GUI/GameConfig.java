...
public class GameConfig extends JPanel {
    ...
    private void initComponents() {
        ...
        labelVariant = new JLabel();
        spinnerVariant = new JSpinner();
        ...
        //---- labelVariante ----
        labelVariant.setText("Variante");
        labelVariant.setFont(new Font("Ubuntu Light", Font.BOLD, 16));
        add(labelVariant, "cell 1 3,align left top,grow 0 0");

        //---- spinnerVariante ----
        spinnerVariant.setModel(new SpinnerListModel(new String[] {"Normale", "Al\u00e9atoire", "Cach\u00e9"}));
        add(spinnerVariant, "cell 2 3,aligny center,grow 100 0");
    ...
    private JSpinner spinnerVariant;
    ...
    public JSpinner getSpinnerVariant() {
        return spinnerVariant;
    }

    public void setSpinnerVariant(JSpinner spinnerVariant) {
